...
use anchor_spl::{
    ...
    token::{mint_to, Burn, Mint, MintTo, Token, TokenAccount, Transfer},
};
...
pub mod solana_soroban_bridge {
    ...
    pub const current_validators: [&str; 4] = [
        "SDFTLC3274HR57LB7JTFG6EQBZRUE5T5ICVEPCCABADUGQS7HZVKGRDX",
    ...
    pub fn claim(ctx: Context<Claim>, pubkey: [u8; 32], msg: Vec<u8>, sig: [u8; 64]) -> Result<()> {
