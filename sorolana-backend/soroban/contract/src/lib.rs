...
use soroban_sdk::{
    contract, contracterror, contractimpl, symbol_short, token, Address, Bytes,
    BytesN, ConversionError, Env, IntoVal, String, Symbol, TryFromVal, Val,
};

mod token_contract {
    soroban_sdk::contractimport!(
        file = "/home/im/KT/sorolana_complete/sorolana_backend/sorolana/soroban/contract/token/soroban_token_contract.wasm"
    );
}
